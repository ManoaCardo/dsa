...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    .format(" D [gün], H [saat], m [dakika], s [saniye]");
      ...
      .addFields({ name: 'Bot Sahibi', value: `f3l1xx#1881`, inline: false})
      .addFields({ name: '• Bellek Kullanımı', value: `${(process.memoryUsage().heapUsed /1024 /512).toFixed(2)}MB`, inline: true})
      .addFields({ name: '• Çalışma Süresi', value: `16 yıl+`, inline: true})
      ...
      .addFields({ name: '• İşletim Sistemi', value: `Windows 11 Pro Max`, inline: false})
      ...
      .addFields({ name: '• Bot Kuruluş', value: `27 Ağustos`, inline: true})
      .addFields({ name: '• Komut Sayısı', value: `♾`, inline: true})
